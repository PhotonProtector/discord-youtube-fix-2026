...
**[PhotonProtector/discord-youtube-fix-2026](https://github.com/PhotonProtector/discord-youtube-fix-2026)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/PhotonProtector/discord-youtube-fix-2026/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `PhotonProtector/discord-youtube-fix-2026`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/PhotonProtector/discord-youtube-fix-2026/releases/latest) и скачайте архив
